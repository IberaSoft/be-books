...
//Obtiene el Total para mostrar el carrito
function ObtTotal(t){
  return (t);
}
...
//Obtiene todos los productos del carro y los muestra
function imCGetCart(bReport) {
  ...
  ObtTotal(iTotal);//borrar esta linea y la funcion a la q llama + arriba
}
...
//Muestra boton de finalizar pago
function imCShowPayButton() {
	//Muestra finalizar pago 
	var iTotal = 0;
	var sCart = imGetCookie("imOrder");
	var aCart = sCart.split("|");
	var iShipmentType = imGetCookie("imShipment");
