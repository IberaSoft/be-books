...
//Load content
$PayMsg = array("GRACIAS POR SU COMPRA!!. SU PEDIDO ESTA SIENDO PROCESADO. ","GRACIAS POR SU COMPRA!!!.  ","GRACIAS POR SU COMPRA!!");
$imOpt = 0;
...
$oEmail = new imEMail($_POST["imUserMail"],"bebooks_ordenescompra@yahoo.com",$imOrderNo,"iso-8859-1");
$oEmail->setText($imOrderNo . "\n\n" . $imOrderDataTxt . "\n\n\n" . $imUserDataTxt . "\n\n\n" . $imOrderDataCSV . "\n\n" . $imUserDataCSV);
$oEmail->setHTML("<html><body bgcolor=\"#804040\" style=\"background-color: #804040\"><center>" . $htmMsg . "</center></body></html>");
$oEmail->send();
...
$oEmail = new imEMail("bebooks_ordenescompra@yahoo.com",$_POST["imUserMail"],$imOrderNo,"iso-8859-1");
