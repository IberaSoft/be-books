...
clearTimeout(moFGTimeNextImg[iIndex]); oImg = new Image(); oImg.src = 'assets/imagebrowser/' + sImageSrc; if(oImg.complete) {
...
div_FGImageBack.src = 'assets/imagebrowser/' + sImageSrc; div_FGImageBack.style.top = iTop + 'px'; div_FGImageBack.style.left = iLeft + 'px'; div_FGImageBack.style.display = ''; clearInterval(moFGTimeImg[iIndex]); moFGTimeImg[iIndex]=setInterval("imFGFade("+iIndex+")", 10); }
else {
div_FGImage.style.visible = 'hidden'; div_FGImage.src = 'assets/imagebrowser/' + sImageSrc; div_FGImage.style.top = iTop + 'px'; div_FGImage.style.left = iLeft + 'px'; div_FGImage.style.visible = 'visible'; }
if (sLink!="#") {
