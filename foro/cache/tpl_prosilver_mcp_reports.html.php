		...
		<?php $_postrow_count = (isset($this->_tpldata['postrow'])) ? sizeof($this->_tpldata['postrow']) : 0;if ($_postrow_count) {for ($_postrow_i = 0; $_postrow_i < $_postrow_count; ++$_postrow_i){$_postrow_val = &$this->_tpldata['postrow'][$_postrow_i]; ?>
			<li class="row<?php if (($_postrow_val['S_ROW_COUNT'] & 1)  ) {  ?> bg1<?php } else { ?> bg2<?php } ?>">
				<dl>
					...
					<dd class="moderation">
						<span><?php echo $_postrow_val['REPORTER_FULL']; ?> <?php echo ((isset($this->_rootref['L_REPORTED_ON_DATE'])) ? $this->_rootref['L_REPORTED_ON_DATE'] : ((isset($user->lang['REPORTED_ON_DATE'])) ? $user->lang['REPORTED_ON_DATE'] : '{ REPORTED_ON_DATE }')); ?> <?php echo $_postrow_val['REPORT_TIME']; ?><br />
						<?php echo ((isset($this->_rootref['L_FORUM'])) ? $this->_rootref['L_FORUM'] : ((isset($user->lang['FORUM'])) ? $user->lang['FORUM'] : '{ FORUM }')); ?>: <a href="<?php echo $_postrow_val['U_VIEWFORUM']; ?>"><?php echo $_postrow_val['FORUM_NAME']; ?></a></span>
					</dd>
